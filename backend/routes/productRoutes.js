...
router.post("/", protect, admin, async (req, res) => {
    try{
        ...
        const product = new Product({
            ...
            weight,
            sku,
            user: req.user._id, //ref to the admin user
        });
...
router.delete("/:id", protect, admin, async (req, res) => {
    try{
        ...
        if(product){
            //Delete the product or remove product fron db
...
// @desc Get a product by using its ID
// @access Public
...
// @route GET /api/products/similaer/:id
// @desc Retrieve similar products by using its ID of the current product's gender and category
// @access Public
router.get("/similar/:id", async (req, res) => {
    ...
    try{
        ...
        const similarProducts = await Product.find({
            _id: {$ne: id}, ///exclude the current product ID and pass the others
    ...
    catch(error)//use to lock the error
    {
        console.error(error);
